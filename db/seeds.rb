...
User.create!(name: "Frank", username: "little_f", password: "HotDog42")
User.create!(name: "Martin", username: "theMartin", password: "martythemartian32")
User.create!(name: "Stu", username: "kookingfool", password: "eatmoreonions")